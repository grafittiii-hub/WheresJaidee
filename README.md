    ...
    <div id="homepage" class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-yellow-400 via-yellow-300 to-green-500 p-4">
        <div class="text-center max-w-lg mx-auto">
            ...
            <div class="mb-6 flex items-center justify-center gap-3">
                <button id="help-btn" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 backdrop-blur-sm border border-white border-opacity-20 flex items-center gap-1.5">
                    <span class="text-base">❓</span>
                    <span data-translate="helpButton">How to Play</span>
                </button>
                
                <button id="language-btn" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 backdrop-blur-sm border border-white border-opacity-20 flex items-center gap-1.5">
                    <span class="text-base">🌐</span>
